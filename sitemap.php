...
//////////////////////////////////// Options ////////////////////////////////////
$url = "http://www.getvexis.com/"; //The Url of the site - the last '/' is needed
...
//$always_ignore = array('includes','config');
$always_ignore = array('');

//These files will not be linked in the sitemap.
//$ignore_files = array('globals.php','settings.php','config.php','validator.php','libraries.php');
$ignore_files = array('changelog','sitemap.php');

//The script will not enter these folders
$ignore_folders = array('files', 'gateways', 'includes', 'libraries', 'modules', 'products', 'scripts', 'skins', 'styles', 'domains');
